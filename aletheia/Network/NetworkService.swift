...
extension NetworkConfiguration {
    ...
    func post<Request: Encodable, Response: Decodable>(url: URL, body: Request) async throws
        -> Response
    {
...
final class NetworkService: NetworkConfiguration {
    ...
    func get<Model: Decodable>(url: URL, headers: [String: String]?) async throws -> Model {
        ...
        do {
            (data, response) = try await makeRequest(
                url: url, method: "GET", body: nil, headers: headers)
    ...
    func post<Request: Encodable, Response: Decodable>(
        url: URL, body: Request, headers: [String: String]? = nil
    ) async throws -> Response {
        var request = URLRequest(url: url, cachePolicy: .reloadIgnoringLocalCacheData)
        ...
        do {
            ...
            throw NetworkError.decoding(
                type: String(describing: Response.self), error: decodingError)
        }
    }
    ...
    private func makeRequest(url: URL, method: String, body: Data?, headers: [String: String]?)
